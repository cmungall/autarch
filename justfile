...
# Use a repo-specific MkDocs port to avoid collisions with other local docs servers.
mkdocs-host := '127.0.0.1'
mkdocs-port := '8137'
...
gh-add-topics:
  gh repo edit --add-topic "autarch,monarchinitiative,linkml"
