...
class ShortChainFattyAcylCoADehydrogenaseActivity(ReactionClass):
    """short-chain fatty acyl-CoA dehydrogenase activity."""

    GO_ID = "GO:0016937"
    EVALUATION_EVIDENCE = IDENTIFIER_FRIENDLY_EVIDENCE
    SUBSTRATE_TO_PRODUCT = {
        "CHEBI:57371": "CHEBI:57332",
        "CHEBI:87487": "CHEBI:87488",
    }
    ...
    def check_membership_impl(self, reaction: Reaction) -> ClassificationResult:
        forward = self._check_direction(
            ...
            explanation="short-chain fatty acyl-CoA dehydrogenase activity: ETF-linked oxidation of a short-chain fatty acyl-CoA",
        )
        ...
        reverse = self._check_direction(
            ...
            explanation="short-chain fatty acyl-CoA dehydrogenase activity: ETF-linked oxidation of a short-chain fatty acyl-CoA (reverse reaction orientation)",
        )
        if reverse.is_member:
            return reverse
        return forward

    def _check_direction(self, left_ids: list[str], right_ids: list[str], substrate_to_product: dict[str, str], explanation: str) -> ClassificationResult:
        ...
        if substrate_to_product.get(left_core[0]) != right_core[0]:
            return ClassificationResult(is_member=False, explanation="Acyl-CoA branch does not match a supported short-chain substrate pair")
