...
class MonosaccharideTransmembraneTransporterActivity(ReactionClass):
    """monosaccharide transmembrane transporter activity."""
    ...
    def check_membership_impl(self, reaction: Reaction) -> ClassificationResult:
        ...
        if not all(
            ...
            return ClassificationResult(
                is_member=False,
                explanation="Transported substrate is not a monosaccharide",
            )

        return ClassificationResult(
            is_member=True,
            explanation="Monosaccharide transmembrane transporter activity",
        )
